...
--RESIZED TOOLTIP ANCHOR DO NOT MEAN RESIZE TOOLTIP FRAME, PAY ATTENTION!!!

if not C["tooltip"].enable then return end

local TukuiTooltip = CreateFrame("Frame", "TukuiTooltip", UIParent)
TukuiTooltip:Point("BOTTOMRIGHT",TukuiMinimap,"BOTTOMLEFT", -1, 0)
...
anchor:SetSize(370-144, TukuiInfoRight:GetHeight())
anchor:SetFrameStrata("TOOLTIP")
anchor:SetFrameLevel(20)
anchor:SetClampedToScreen(true)
anchor:Point("BOTTOMRIGHT",TukuiMinimap,"BOTTOMLEFT", -1, 0)
anchor:SetAlpha(0)
if C.chat.background and TukuiChatBackgroundRight then
	...
	--anchor:SetPoint("BOTTOLEFT", TukuiMinimap)
	anchor:Point("BOTTOMRIGHT",TukuiMinimap,"BOTTOMLEFT", -1, -TukuiInfoRight:GetHeight()-3)
end
